...
public partial class SelectEmbeddedModelView : SelectVoskModelView
{
    public SelectEmbeddedModelView()
    {
        Selector.Configure(
            header: "Select Model",
            subheader: "Higher versions work better",
            customPathHint: "...or if you happen to know the location of one:");
        Models = _vscExtensions;
        ContinueButton.Click -= ContinueButtonClicked;
        ContinueButton.Click += ContinueClicked;
    }

    private static SttKind Kind => SttKind.Embedded;

    public void UpdateModels()
    {
	    Selector.SetModelNames([..SttManager.SpeechModels.Keys, ..Models.Keys]);
    }
    ...
    private async void ContinueClicked(object? sender, RoutedEventArgs e)
    {
        ...
        {
            string? eula = EmbeddedSpeechLocator.GetEula(Selector.CustomModelPathValue);
            ...
            string? version = EmbeddedSpeechLocator.GetVersion(Selector.CustomModelPathValue);
            ...
            SttManager.Model = new(eula, Selector.CustomModelPathValue, version);
        ...
        DownloadableModel model = _vscExtensions[selectedModel];
    ...
    private readonly Dictionary<string, DownloadableModel> _vscExtensions = new()
    {
