...
public partial class PhraseList : UserControl
{
    private readonly ObservableCollection<Data.PhraseEntry> _phrases = [];

    public List<Data.PhraseEntry> Phrases => _phrases
    ...
    private void PhraseRemove(object? sender, Data.PhraseEntry e)
    {
        _phrases.Remove(e);
    }

    private void MovePhraseUp(object? sender, Data.PhraseEntry e)
    {
    ...
    private void MovePhraseDown(object? sender, Data.PhraseEntry e)
    {
        int index = _phrases.IndexOf(e);
    ...
    {
        var entry = ((sender as PhraseListItem)!.DataContext as Data.PhraseEntry)!;
