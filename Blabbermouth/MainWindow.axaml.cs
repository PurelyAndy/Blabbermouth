...
using Blabbermouth.ModelSelection;
...
public partial class MainWindow : Window
{
    ...
    private readonly SelectEmbeddedModelView _embeddedModelSelector = new();
    private readonly SelectVoskModelView _voskModelSelector = new();
    private readonly SelectSherpaOnnxModelView _sherpaOnnxModelSelector = new();
    ...
    private async Task ShowModelDialogAsync(SelectModelView selectorControl)
    {
    ...
    private void CollapseButtonClick(object? sender, RoutedEventArgs e)
    {
        ...
        CollapseButton.Content = new Avalonia.Controls.Shapes.Path
        {
    ...
    private async void ExportPhrases(object? sender, RoutedEventArgs e)
    {
        ...
        Settings.Set("lastLocation", Path.GetDirectoryName(file.Path.LocalPath));
    ...
    private async void ImportPhrases(object? sender, RoutedEventArgs e)
    {
        ...
        {
            await DialogHost.Show(new DialogBox(Dialog,
                ...
                "Failed to import phrases", "OK"), Dialog);
        }
    }
